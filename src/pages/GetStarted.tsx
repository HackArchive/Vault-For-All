        ...
        <header className="myheader transform -skew-y-12 bg-gradient-to-r from-pink-500 via-blue-400  to-yellow-300">
            ...
            <div className=" lg:px-28 lg:py-4 px-2 py-2  transform skew-y-12 ">
                ...
                <nav>
                    ...
                    <div>
                        <Link to="/addWallet"  className="flex bg-black py-2 px-4 text-sm bg-white bg-opacity-20 text-white rounded-full">
                            Get Started
                ...
                <div className="lg:grid lg:grid-cols-2 block lg:px-30 lg:py-16 px-2 py-2">
                    <div className="">
                    <button  className="flex bg-black mt-4 py-1 px-4 mb-4 bg-opacity-20 text-xs text-white rounded lg:rounded-full">
                        now with Alexa notification system
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" viewBox="0 0 20 20" fill="currentColor">
                            <path fill-rule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clip-rule="evenodd" />
                        </svg>
                    </button>
                    <h1 className="pt-10 mt-10 lg:text-7xl text-6xl py-10 lg:py-0 font-bold text-opacity-80 text-gray-900">Shit Wallet for your web3 Payments</h1>
                    </div>
